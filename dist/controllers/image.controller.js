...
exports.remove = exports.like = exports.index = exports.create = exports.comment = void 0;
...
var index = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(req, res, next) {
    var viewModel, image, updatedImage, comments;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            return _context.abrupt("return", next(new Error("No se encontro la publicacion")));

          case 6:
            _context.next = 8;
            return _models.Image.findOneAndUpdate({
              _id: image.id
            }, {
              $inc: {
                views: 1
          ...
          case 8:
            updatedImage = _context.sent;
            viewModel.image = updatedImage; // get image comments
      ...
      return _regenerator["default"].wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 23:
              res.status(500).json({
                error: "Unicamente se aceptan imagenes"
              });
...
var comment = /*#__PURE__*/function () {
  ...
  return function comment(_x6, _x7) {
